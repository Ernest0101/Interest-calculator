...
#capitalise used to make sure all user input is in the same case
...
try:
    ...
    print('This input was invalid, Please try again.')
#try except block used to prevent the programe crashing
